...
- Message Sending: Integrated with Vercel Serverless Functions to send professional project requests directly to your email.
...
|:---:|:---:|
| ![Recent Work](src/assets/recent-work.png) | ![Value Proposition](src/assets/value-proposition.png) |

| Project Estimator | Requirements Gathering |
|:---:|:---:|
| ![Project Estimator](src/assets/project-estimator.png) | ![Requirements Gathering](src/assets/requirements-gathering.png) |
